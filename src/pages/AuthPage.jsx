...
export default function AuthPage() {
  const { isRegistering, toggleAuthMode, signInWithGoogle, handleEmailAuth } = useApp();
            ...
            <div className="card auth-card text-center animate-fade-in">
              <div className="card-body p-5">
                ...
                <form onSubmit={submit}>
                  ...
                  <button type="submit" className="btn btn-primary-custom w-100 py-3 mt-3 shadow">
                ...
                <div className="mt-4">
                  <small className="text-muted">
                    ...
                    <a href="#" className="text-primary fw-bold text-decoration-none" onClick={(e) => { e.preventDefault(); toggleAuthMode(); }}>
