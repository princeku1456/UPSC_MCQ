  ...
  Historical_Background: [
    {
      ...
      explanation:
        "The Montagu-Chelmsford Reforms (1919) replaced the single-chamber Imperial Legislative Council with a bicameral legislature consisting of an Upper House (Council of State) and a Lower House (Legislative Assembly). The Government of India Act, 1935, envisaged an All-India Federation comprising British Indian Provinces and Princely States, although the federation never materialized as the states did not join.",
    },
    {
      text: "Which of the following are the principal features of the Government of India Act, 1919?\n1. Introduction of dyarchy in the executive government of the Provinces.\n2. Introduction of separate communal electorates for Muslims.\n3. Devolution of legislative authority by the Centre to the Provinces.\n4. Expansion and reconstitution of Central and Provincial Legislatures.",
      options: ["1, 2 and 3", "2, 3 and 4", "1, 2 and 4", "1, 3 and 4"],
      correctAnswer: "1, 3 and 4",
      explanation:
        "Separate communal electorates for Muslims were actually introduced by the Morley-Minto Reforms of 1909. The 1919 Act extended this system to Sikhs, Indian Christians, Anglo-Indians, and Europeans. It also introduced Dyarchy (dual rule) in provinces and decentralized authority by separating central and provincial subjects.",
    },
    {
      ...
      correctAnswer: "Both 1 and 2",
      explanation:
        "The Central Public Service Commission was established in 1926 following the recommendations of the Lee Commission (1924). The 1935 Act further expanded this by establishing the Federal Public Service Commission and providing for Provincial and Joint Public Service Commissions.",
    },
    {
      text: "Which one of the following Acts provided the setting up of a Board of Control in Britain, through which the British Government could fully control the British East India Company's civil, military and revenue affairs in India?",
      options: [
      ...
      correctAnswer: "Pitt's India Act of 1784",
      explanation:
        "Pitt's India Act established a system of 'Double Government' by creating a Board of Control to manage political affairs (civil, military, and revenue), while the Court of Directors continued to manage commercial affairs.",
    },
    {
      text: "Match List I (Acts) with List II (Provisions):\nA. The Government of India Act, 1935 - 3. Introduction of provincial autonomy\nB. The Indian Councils Act, 1909 - 5. Introduction of separate electorate for Muslims\nC. The Government of India Act, 1919 - 4. Introduction of Dyarchy in provinces\nD. The Government of India Act, 1858 - 1. Transfer of power from the East India Company to the British crown",
      options: [
        "A-1, B-4, C-2, D-3",
        "A-3, B-5, C-4, D-1",
        "A-1, B-5, C-4, D-3",
      ...
      correctAnswer: "A-3, B-5, C-4, D-1",
      explanation:
        "The 1935 Act ended dyarchy in provinces and introduced Provincial Autonomy. The 1909 Act introduced communal representation for Muslims. The 1919 Act introduced Dyarchy in provinces, and the 1858 Act transferred Indian administration directly to the British Crown after the 1857 revolt.",
    },
    {
      text: "Partially responsible governments in the provinces were established under which one of the following Acts?",
      options: [
      ...
      correctAnswer: "The Government of India Act, 1919",
      explanation:
        "The 1919 Act introduced Dyarchy in the provinces, where provincial subjects were divided into 'Transferred' (administered by the Governor with ministers responsible to the legislature) and 'Reserved' (administered by the Governor and executive council without responsibility to the legislature).",
    },
    {
      text: "The initial idea of recruitment on merit principle can be traced to the:",
      options: [
        "Lee Commission",
        "Macaulay Committee",
      ...
      correctAnswer: "Macaulay Committee",
      explanation:
        "The Macaulay Committee (Committee on the Indian Civil Service) was appointed in 1854 following the Charter Act of 1833's proposal for an open competitive system for selection of civil servants, which was formally implemented in 1854-55.",
    },
    {
      text: "During the period of British rule in India, the rules made under which one of the following were known as the Devolution Rules?",
      options: [
      ...
      correctAnswer: "Government of India Act, 1919",
      explanation:
        "Under the 1919 Act, 'Devolution Rules' were framed to separate central and provincial subjects, allowing provinces to legislate on matters within their own sphere for the first time.",
    },
    {
      text: "Which one of the following pairs is correctly matched?",
      options: [
        "Indian Councils Act, 1892 : Principle of Election",
        "Indian Councils Act, 1909 : Responsible Government",
        "Government of India Act, 1919 : Provincial Autonomy",
        "Government of India Act, 1935 : Dyarchy in States",
      ],
      correctAnswer: "Indian Councils Act, 1892 : Principle of Election",
      explanation:
        "The 1892 Act introduced a limited and indirect use of election for filling non-official seats in the councils. Responsible government was not introduced in 1909; 1919 introduced Dyarchy (not autonomy); and 1935 introduced Provincial Autonomy (not dyarchy in states).",
    },
    {
      text: "Assertion (A): Notwithstanding the introduction of Provincial Autonomy, the Government of India Act, 1935 retained control of the Central Government over the Provinces in a certain sphere.\nReason (R): The Governor was required to act in his own discretion in certain matters for which he was to act without ministerial advice and under the control and directions of the Governor-General.",
      options: [
      ...
      correctAnswer:
        "Both A and R are individually true and R is the correct explanation of A",
      explanation:
        "While the 1935 Act granted autonomy to provinces, the Governor still possessed 'discretionary powers' and 'special responsibilities.' In these areas, he acted under the direction of the Governor-General, thereby maintaining central control.",
    },
    {
      text: "In the Federation established by the Act of 1935, residuary powers were given to the:",
      options: [
        "Federal Legislature",
      ...
      correctAnswer: "Governor General",
      explanation:
        "The 1935 Act divided powers into Federal, Provincial, and Concurrent lists. Residuary powers—those not listed in any of the three lists—were vested in the Governor-General at his discretion.",
    },
    {
      text: "Match List I (Acts) with List II (Provisions):\nA. Government of India Act, 1858 - 2. Appointment of Secretary of State for India\nB. Indian Councils Act, 1861 - 3. Beginning of representation and legislative devolution\nC. Indian Councils Act, 1909 - 5. Morley-Minto Reforms\nD. Government of India Act, 1919 - 4. Dyarchy in Provinces",
      options: [
        "A-1, B-2, C-3, D-4",
        "A-2, B-3, C-5, D-4",
        "A-3, B-4, C-5, D-1",
      ...
      correctAnswer: "A-2, B-3, C-5, D-4",
      explanation:
        "The 1858 Act created the office of the Secretary of State. The 1861 Act initiated the association of Indians with the law-making process (representation). The 1909 Act is the Morley-Minto reforms, and the 1919 Act introduced Dyarchy in provinces.",
    },
    {
      text: "The Government of India Act, 1919, was based upon:",
      options: [
      ...
      correctAnswer: "Montague-Chelmsford Report",
      explanation:
        "The Act was based on the proposals of Edwin Montagu (Secretary of State) and Lord Chelmsford (Viceroy), hence it is popularly known as the Montagu-Chelmsford Reforms.",
    },
    {
      text: "Under which one of the following Acts, was the Communal Electorate System introduced by the British in India, for the first time?",
      options: [
      ...
      correctAnswer: "Government of India Act, 1909",
      explanation:
        "The Indian Councils Act of 1909 introduced a system of separate electorates for Muslims, where Muslim candidates could only be elected by Muslim voters, legalizing communalism in Indian politics.",
    },
    {
      text: "What were the salient features of the Government of India Act, 1935?\n1. Abolition of Council of India\n2. Dyarchy at the Centre\n3. Abolition of Dyarchy in the States\n4. Establishment of Federal Court",
      options: ["2 and 3", "1, 2 and 3", "1, 3 and 4", "1, 2, 3 and 4"],
      correctAnswer: "1, 2, 3 and 4",
      explanation:
        "All these were features of the 1935 Act: it abolished the Council of India (established in 1858), introduced dyarchy at the central level, replaced provincial dyarchy with autonomy, and established a Federal Court (set up in 1937).",
    },
    {
      text: "Match List-I (Feature) with List-II (Act):\nA. Federal Scheme of Government - 3. Government of India Act, 1935\nB. Dyarchy in Provincial Government - 4. Montague-Chelmsford Reforms, 1919\nC. Communal representation - 1. Minto-Morley Reforms, 1909\nD. Rigid centralization - 2. Indian Councils Act, 1861",
      options: [
        "A-2, B-1, C-4, D-3",
        "A-3, B-4, C-1, D-2",
        "A-2, B-4, C-1, D-3",
      ...
      explanation:
        "The 1935 Act proposed a federation. The 1919 reforms introduced provincial dyarchy. The 1909 reforms introduced communal representation. The 1861 Act, while starting devolution, still maintained a rigid central structure compared to later reforms.",
    },
    {
      text: "Who among the following was the Finance Minister of India in the Interim Government during 1946-1947?",
      options: [
      ...
      explanation:
        "Liaquat Ali Khan, representing the Muslim League, was the Finance Member in the Interim Government. After partition, R.K. Shanmukham Chetty became the first Finance Minister of independent India.",
    },
    {
      text: "Which one of the following Acts laid the foundation of the British Administration in India?",
      options: [
        "Regulating Act, 1773",
      ...
      correctAnswer: "Regulating Act, 1773",
      explanation:
        "The Regulating Act of 1773 was the first step by the British Government to control and regulate the affairs of the East India Company in India, laying the foundation of central administration.",
    },
    {
      text: "Match List-I (Provisions) with List-ll (Acts):\nA. Designation of the Governor-General of Bengal as the Governor-General of India - 1. Charter Act of 1833\nB. Dyarchy introduced in Indian Government - 4. Government of India Act, 1919\nC. Twin features of All-India Federation and Provincial Autonomy - 3. Government of India Act, 1935\nD. Control of the Government of India transferred from East India Company to the British Crown - 2. Government of India Act, 1858",
      options: [
        "A-1, B-4, C-3, D-2",
        "A-2, B-3, C-4, D-1",
        "A-1, B-3, C-4, D-2",
      ...
      correctAnswer: "A-1, B-4, C-3, D-2",
      explanation:
        "The 1833 Charter Act created the Governor-General of India (Lord William Bentinck). The 1919 Act introduced dyarchy (dual government) in provinces. The 1935 Act featured federation and provincial autonomy. The 1858 Act ended Company rule.",
    },
    {
      text: "Who among the following was the first Law Minister of India?",
      options: [
        "Jawahar Lal Nehru",
      ...
      correctAnswer: "Dr. BR Ambedkar",
      explanation:
        "Dr. B.R. Ambedkar, the chief architect of the Indian Constitution, served as the first Minister of Law and Justice in the cabinet of independent India.",
    },
    {
      text: "With reference to the period of British Rule in India, Indian Statutory Commission is popularly known as:",
      options: [
        "Cabinet Mission",
        "Hunter Commission",
        "Sadlar Commission",
      ...
      correctAnswer: "Simon Commission",
      explanation:
        "The Indian Statutory Commission, headed by Sir John Simon, was appointed in 1927 to report on the working of the 1919 Act and suggest further reforms.",
    },
    {
      text: "During the British Rule in India, who was the first Indian to be appointed as Law Member of the Governor General's Council?",
      options: [
      ...
      correctAnswer: "Satyendra Sinha",
      explanation:
        "Satyendra Prasad Sinha became the first Indian to join the Viceroy’s Executive Council as the law member following the Morley-Minto Reforms of 1909.",
    },
  ],
  Making_of_the_Constitution: [
    {
      text: "Consider the following statements regarding the composition of the Constituent Assembly:\n1. The representatives were to be elected from the four constituents-Hindu, Muslim, Sikh and Christian.\n2. The chairman of the Union Constitution Committee was Sardar Vallabhbhai Patel.\n3. The total strength of the Constituent Assembly was 389.\n4. The Drafting Committee under the chairmanship of Dr. B.R. Ambedkar consisted of eight members.",
      options: ["1, 2, 3 and 4", "1, 2 and 4", "3 only", "1 only"],
      correctAnswer: "3 only",
      explanation:
        "Only statement 3 is correct. Seats were divided into three (not four) communities: Muslim, Sikh, and General. Jawaharlal Nehru (not Patel) was the chairman of the Union Constitution Committee. The Drafting Committee had seven (not eight) members.",
    },
    {
      text: "Which of the following provisions of the Constitution of India was/were given immediate effect from November 26, 1949?\n1. Citizenship\n2. Emergency provisions\n3. Elections\n4. Federal system",
      options: ["Only 1", "2 and 3", "1 and 4", "1 and 3"],
      correctAnswer: "1 and 3",
      explanation:
        "On Nov 26, 1949, certain provisions like Citizenship (Articles 5-9), Elections (Art 324), and Provisional Parliament came into force immediately. The rest of the Constitution commenced on Jan 26, 1950.",
    },
    {
      text: "What was the procedure followed for adoption of the Constitution of India?",
      options: [
        "It was submitted to the people of India for ratification.",
        "It was submitted to the Governor-General for his assent.",
        "It was adopted when the interim government approved it.",
        "It was adopted when it received the signature of the President and Members of the Constituent Assembly.",
      ],
      correctAnswer:
        "It was adopted when it received the signature of the President and Members of the Constituent Assembly.",
      explanation:
        "The Constitution was finalized and signed by the President of the Assembly (Dr. Rajendra Prasad) and other members on November 26, 1949, signifying its formal adoption.",
    },
    {
      text: "Who among the following was the Chairman of the States Committee of the Constituent Assembly?",
      options: [
        "Dr. B.R. Ambedkar",
        "Jawaharlal Nehru",
        "Dr. Rajendra Prasad",
      ...
      explanation:
        "Jawaharlal Nehru chaired the States Committee (Committee for Negotiating with States) as well as the Union Powers and Union Constitution Committees.",
    },
    {
      text: "The Constitution of India as framed by the Constituent Assembly was finally adopted and enacted on:",
      options: [
        "15th August, 1947",
        "30th January, 1948",
        "26th November, 1949",
      ...
      explanation:
        "November 26, 1949 is known as 'Constitution Day' because the drafting process was completed and the document was adopted on this date.",
    },
    {
      text: "Match List-I (Committee) with List-II (Chairman):\nA. Steering Committee - 2. Dr. Rajendra Prasad\nB. Fundamental Rights Sub-Committee - 3. J.B. Kripalani\nC. Union Constitution Committee - 4. Jawaharlal Nehru\nD. Provincial Constitution Committee - 1. Sardar Vallabhbhai Patel",
      options: [
        "A-2, B-3, C-4, D-1",
        "A-1, B-4, C-3, D-2",
        "A-2, B-4, C-3, D-1",
      ...
      explanation:
        "Dr. Rajendra Prasad (President of CA) chaired the Steering Committee. J.B. Kripalani chaired the FR Sub-committee. Nehru headed Union committees, and Patel headed the Provincial Constitution Committee.",
    },
    {
      text: "The members of the Constituent Assembly were:",
      options: [
      ...
      correctAnswer:
        "Elected by the Legislatures of various provinces and nominated by the rulers of the princely states.",
      explanation:
        "The Constituent Assembly was a partly elected and partly nominated body. Provincial representatives were elected by provincial legislative assemblies, while princely state representatives were nominated by their rulers.",
    },
    {
      text: "Who among the following was the Constitutional Advisor to the Constituent Assembly?",
      options: [
        "Dr. B.R. Ambedkar",
        "K.M. Munshi",
        "Sir B.N. Rau",
      ...
      correctAnswer: "Sir B.N. Rau",
      explanation:
        "Sir B.N. Rau was appointed as the Legal Advisor and prepared the initial draft of the Constitution which was then considered by the Drafting Committee.",
    },
    {
      text: "Assertion (A): The Constituent Assembly of 1946 was not elected on the basis of universal adult franchise.\nReason (R): The Constituent Assembly was constituted under the scheme formulated by the Cabinet Mission Plan.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer:
        "Both A and R are individually true and R is the correct explanation of A",
      explanation:
        "The Cabinet Mission Plan of 1946 opted for indirect election by provincial assemblies rather than direct election by the masses to avoid delay in the constitutional process.",
    },
    {
      text: "Who among the following moved the 'Objectives Resolution' in the Constituent Assembly?",
      options: [
        "B.N. Rao",
        "B.R. Ambedkar",
        "Jawaharlal Nehru",
      ...
      correctAnswer: "Jawaharlal Nehru",
      explanation:
        "On December 13, 1946, Nehru moved the Objectives Resolution, which outlined the philosophy of the Constitution and later evolved into the Preamble.",
    },
    {
      ...
      correctAnswer: "Both 1 and 2",
      explanation:
        "Following the French practice of electing the oldest member, Dr. Sinha was made temporary President on Dec 9, 1946. Later, Dr. Rajendra Prasad was elected President, and H.C. Mukherjee and V.T. Krishnamachari were elected Vice-Presidents.",
    },
  ],
  Salient_Features_of_the_Constitution: [
    {
      text: "Which of the following statements about the Constitution of India is/are correct?\n1. Popular sovereignty and adult franchise are the basic features of the Constitution.\n2. The Constitution, in so far as the division of powers between the Centre and the States is concerned, is rigid.\n3. The Constitution recognises the interdependence of civil and economic rights.\n4. The Constitution mentions direct control by the people such as referendum, initiative and recall.",
      options: ["Only 1", "1, 2 and 4", "2, 3 and 4", "1, 2 and 3"],
      correctAnswer: "1, 2 and 3",
      explanation:
        "India is a representative democracy; it does not have provisions for direct democratic tools like referendum, initiative, or recall. Statements 1, 2, and 3 are correct descriptions of our constitutional framework.",
    },
    {
      text: "Consider the following statements related to secularism in India:\n1. It entails strict separation of religion from politics.\n2. It bans parties with religious affiliations from contesting elections.\n3. It grants religious liberty to all communities.\n4. It accepts community personal laws.",
      options: ["3 and 4", "1 and 2", "1, 3 and 4", "1, 2, 3 and 4"],
      correctAnswer: "1, 3 and 4",
      explanation:
        "In the Indian context, secularism means 'Sarva Dharma Sambhava' (equal respect for all religions). It does not strictly ban religious parties but grants liberty and acknowledges personal laws, while striving for a common civic culture.",
    },
    {
      text: "Which one of the following Schedules of the Constitution of India incorporates salaries and allowances of members of Parliament, the Chairman and Deputy Chairman of the Rajya Sabha, and Speaker and Deputy Speaker of the Lok Sabha?",
      options: [
        "Fifth Schedule",
        "Seventh Schedule",
        "Ninth Schedule",
      ...
      explanation:
        "While salaries of high officials (Pres, Judges, etc.) are in the Second Schedule, the authority to determine salaries of MPs lies with Parliament via legislation. This power is found in the Union List of the Seventh Schedule.",
    },
    {
      text: "Match List-I (Subject) with List-II (Part):\nA. Finance, Property, Contracts and Suits - 2. Part XII\nB. The Union Judiciary - 1. Part V\nC. The Executive of States - 4. Part VI\nD. Relations between the Union and the States - 3. Part XI",
      options: [
        "A-4, B-3, C-2, D-1",
        "A-2, B-1, C-4, D-3",
        "A-4, B-1, C-2, D-3",
      ...
      explanation:
        "Part V covers the Union (Executive, Parliament, Judiciary). Part VI covers States. Part XI covers relations between Union and States. Part XII covers finance, property, and contracts.",
    },
    {
      text: "Which one of the following is not a salient feature of the Constitution of India?",
      options: [
      ...
      correctAnswer: "Committed Judiciary",
      explanation:
        "The Indian Constitution provides for an 'Independent Judiciary' to ensure the rule of law. A 'committed judiciary' (committed to the government's ideology) is contrary to constitutional principles.",
    },
    {
      ...
      correctAnswer: "2 and 3 are correct",
      explanation:
        "India has the lengthiest written constitution in the world. It borrowed nearly 75% of its structural part (administrative details) from the Government of India Act, 1935.",
    },
    {
      text: "The Second Schedule of the Constitution of India does not contain the provisions as to who among the following?",
      options: [
        "The President",
      ...
      correctAnswer: "The Chairman, Union Public Service Commission",
      explanation:
        "The Second Schedule lists salaries of the President, Governors, Speaker/Deputy Speaker, Chairman/Deputy Chairman, Judges, and CAG. It does not include the UPSC Chairman.",
    },
    {
      text: "Match List-I (Provisions) with List-II (Source):\nA. Emergency Provisions - 4. Germany\nB. Fundamental Rights - 3. The United States of America\nC. Parliamentary System - 2. The United Kingdom\nD. Directive Principles of State Policy - 1. Ireland",
      options: [
        "A-4, B-1, C-2, D-3",
        "A-2, B-3, C-4, D-1",
        "A-4, B-3, C-2, D-1",
      ...
      explanation:
        "FRs were inspired by the US Bill of Rights. DPSP was taken from the Irish Constitution. The Parliamentary system came from the UK, and the suspension of FRs during emergency was borrowed from the Weimar Constitution of Germany.",
    },
    {
      ...
      correctAnswer: "The forms of oaths or affirmations : Second Schedule",
      explanation:
        "Oaths and affirmations are contained in the Third Schedule. The Second Schedule deals with salaries and emoluments.",
    },
    {
      text: "Consider the following statements with reference to Secularism in India:\n1. Secularism means that the State has no recognised religion of State.\n2. Secularism means that the State treats all the religions equally.\n3. Secularism means that the State regulates the relation of man with God.",
      options: ["1, 2 and 3", "1 and 2", "2 and 3", "1 and 3"],
      correctAnswer: "1 and 2",
      explanation:
        "Indian secularism is 'positive' secularism where the state maintains a 'principled distance' from religion but treats all equally and has no official state religion. It does not regulate personal spiritual relations between man and God.",
    },
    {
      text: "Assertion (A): Not contented with merely laying down the fundamental principles of governance, the framers of the Indian Constitution followed the Government of India Act, 1935 in providing matters of administrative details.\nReason (R): The framers of the Indian Constitution had the apprehension that in the prevailing conditions of the country at that time, the Constitution might be subverted unless the form of administration was also included.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      explanation:
        "The Assertion (A) incorrectly cites the GOI Act 1919 (as per the source snippet's claim, though the reasoning refers to 1935). Since the Constitution followed the 1935 Act for administrative details, A as phrased with '1919' is false, while the reasoning for including details to prevent subversion is true.",
    },
    {
      text: "Which one of the following statements correctly describes the Seventh Schedule of the Constitution of India?",
      options: [
        "It contains the languages recognised in the Constitution.",
      ...
      correctAnswer:
        "It lists distribution of powers between the Union and the States.",
      explanation:
        "The Seventh Schedule contains three lists: Union List, State List, and Concurrent List, defining the legislative jurisdiction of the Centre and the States.",
    },
    {
      ...
      correctAnswer: "1 and 3 are correct",
      explanation:
        "India has a 'quasi-federal' system (federal in form but unitary in spirit) rather than a 'strictly' federal one like the USA. However, single citizenship and the mix of rigidity/flexibility for amendments are key features.",
    },
    {
      text: "Match List-I (Schedule) with List-II (Content):\nA. Ninth Schedule - 2. Land reforms legislations\nB. Tenth Schedule - 5. Disqualification on ground of defection\nC. Eleventh Schedule - 1. Panchayati Raj Institutions\nD. Sixth Schedule - 3. Administration of tribal areas",
      options: [
        "A-3, B-1, C-4, D-2",
        "A-2, B-5, C-1, D-3",
        "A-3, B-5, C-1, D-2",
      ...
      correctAnswer: "A-2, B-5, C-1, D-3",
      explanation:
        "The 9th Schedule protects land reform laws from judicial review. The 10th is the anti-defection law. The 11th specifies powers of Panchayats, and the 6th provides for tribal area administration in Assam, Meghalaya, Tripura, and Mizoram.",
    },
  ],

  Preamble_of_the_Constitution: [
    {
      text: "The following are enshrined in the Preamble to the Constitution of India:\n1. Equality of status and opportunity.\n2. Liberty of thought, expression, belief, faith and worship.\n3. Justice—social, economic and political.\n4. Fraternity assuring the dignity of the individual.\n5. Unity and integrity of the Nation.\nWhich one of the following is the correct order in which they appear in the Preamble?",
      options: [
        "5, 1, 2, 4, 3",
        "3, 2, 1, 4, 5",
        "3, 1, 2, 5, 4",
      ...
      explanation:
        "The sequence in the Preamble starts with Justice (Social, Economic, and Political), followed by Liberty (of thought, expression, belief, faith, and worship), then Equality (of status and of opportunity), and finally Fraternity (assuring dignity and unity/integrity).",
    },
    {
      text: "The philosophical postulates of the Constitution of India are based on:",
      options: [
        "Nehru Report, 1928.",
        "Objectives Resolution of Pandit Nehru, 1947.",
        "Mahatma Gandhi’s article ‘Independence in Young India’, 1922.",
        "Indian National Congress’s Resolution for Complete Independence, 1929.",
      ],
      correctAnswer: "Objectives Resolution of Pandit Nehru, 1947.",
      explanation:
        "The Preamble is based on the 'Objectives Resolution', drafted and moved by Pandit Nehru in the Constituent Assembly on December 13, 1946, and adopted on January 22, 1947.",
    },
    {
      text: "The Preamble to the Indian Constitution is:",
      options: [
        "Not a part of the Constitution.",
        "A part of the Constitution but it neither confers any powers nor imposes any duties nor can it be of any use in interpreting other provisions of the Constitution.",
        "A part of the Constitution and can be of use in interpreting other provisions of the Constitution in cases of ambiguity.",
        "A part of the Constitution and it confers powers and imposes duties as any other provisions of the Constitution.",
      ],
      correctAnswer:
        "A part of the Constitution and can be of use in interpreting other provisions of the Constitution in cases of ambiguity.",
      explanation:
        "In the Kesavananda Bharati case, the Supreme Court held that the Preamble is a part of the Constitution. While it is non-justiciable and doesn't grant substantive powers, it serves as a 'key to the minds of the makers' and helps interpret ambiguous provisions.",
    },
    {
      ...
      options: [
        "Freedom of residence anywhere in the country.",
        "Right to establish and administer educational institutions of choice.",
        "Liberty of belief, faith and worship.",
        "Right to education at primary level.",
      ],
      correctAnswer: "Liberty of belief, faith and worship.",
      explanation:
        "The Preamble explicitly mentions securing 'Liberty of thought, expression, belief, faith and worship'. The other options refer to specific Fundamental Rights under Articles 19, 30, and 21A, which are detailed in Part III but not specifically phrased in the Preamble.",
    },
    {
      text: "The term “economic justice” in the Preamble to the Constitution of India, is a resolution for:",
      options: [
        "Equal distribution of wealth.",
        "Economy in the administration of justice.",
        "Socio-economic revolution.",
        "Cheap justice to the poor.",
      ],
      correctAnswer: "Equal distribution of wealth.",
      explanation:
        "Economic justice denotes the non-discrimination between people on the basis of economic factors. It involves the elimination of glaring inequalities in wealth, income, and property to ensure a decent standard of living for all.",
    },
    {
      text: "Match List I with List II and select the correct answer using the codes given below:\nList-I (Terms): A. Republic, B. Secular, C. Democratic, D. Sovereign\nList-II (Implications):\n1. Head of the State is not a hereditary monarch\n2. State does not recognise any religion as a state religion\n3. Government gets its authority from the will of the people\n4. State is free to conduct its own internal and external affairs",
      options: [
        "A-1, B-2, C-3, D-4",
        "A-1, B-3, C-2, D-4",
        "A-2, B-3, C-1, D-4",
      ...
      explanation:
        "Sovereign implies no external control; Democratic implies authority from the people; Secular signifies no state religion; and Republic means an elected head of state rather than a hereditary monarch.",
    },
    {
      text: "The text of the Preamble to the Constitution of India aims to secure:",
      options: [
        "Fundamental rights to all individuals.",
        "Fundamental duties to citizens of India.",
        "Dignity of the individual and unity and integrity of the nation.",
        "Security of service to Government servants.",
      ],
      correctAnswer:
        "Dignity of the individual and unity and integrity of the nation.",
      explanation:
        "The Preamble promotes Fraternity, which is intended to assure two things: the dignity of the individual and the unity and integrity of the nation.",
    },
    {
      text: "Which of the following terms was not included in a ‘Union of Trinity’ by Dr. B.R. Ambedkar in his concluding speech in the Constituent Assembly?",
      options: ["Liberty", "Flexibility", "Equality", "Fraternity"],
      correctAnswer: "Flexibility",
      explanation:
        "Dr. Ambedkar stated that Liberty, Equality, and Fraternity form a 'Union of Trinity' in the sense that to divorce one from the other is to defeat the very purpose of democracy.",
    },
    {
      text: "The words “Socialist” and “Secular” were inserted in the Preamble by the:",
      options: [
        "Fifteenth Amendment",
      ...
      correctAnswer: "Forty-second Amendment",
      explanation:
        "The 42nd Constitutional Amendment Act of 1976 added three new words to the Preamble: 'Socialist', 'Secular', and 'Integrity'.",
    },
    {
      text: "The sequence in which the given terms are mentioned in the Preamble to the Constitution of India is:",
      options: [
        "Sovereign, Socialist, Secular, Democratic, Republic",
        "Socialist, Secular, Sovereign, Democratic, Republic",
        "Secular, Sovereign, Democratic, Socialist, Republic",
        "Sovereign, Democratic, Secular, Socialist, Republic",
      ],
      correctAnswer: "Sovereign, Socialist, Secular, Democratic, Republic",
      explanation:
        "The Preamble declares India to be a 'Sovereign Socialist Secular Democratic Republic'. This specific order reflects the nature of the Indian State.",
    },
    {
      ...
      correctAnswer: "Indicates the objectives to be achieved.",
      explanation:
        "The Preamble acts as an introduction to the Constitution and outlines the fundamental objectives (Justice, Liberty, Equality, Fraternity) that the constitutional framework seeks to achieve for the people of India.",
    },
  ],
  Union_and_Its_Territory: [
    {
      ...
      explanation:
        "Under Article 3, Parliament can alter state boundaries. However, such a bill can be introduced in either House of Parliament, not just the Rajya Sabha, though the President's prior recommendation is mandatory.",
    },
    {
      text: "Consider the following with respect to the Union of India:\n1. Formation of the State of Nagaland.\n2. States Reorganisation Act.\n3. Formation of the State of Haryana.\n4. Formation of the State of Gujarat.\nWhich one of the following is the correct chronological order of the above?",
      options: ["4-2-3-1", "2-4-3-1", "4-2-1-3", "2-4-1-3"],
      correctAnswer: "2-4-1-3",
      explanation:
        "The States Reorganisation Act was passed in 1956. Gujarat was formed in 1960, Nagaland in 1963, and Haryana in 1966.",
    },
    {
      text: "The boundary of a State in India can be altered through the procedure laid down in:",
      options: ["Article 368", "Article 130", "Article 70", "Article 3"],
      correctAnswer: "Article 3",
      explanation:
        "Article 3 of the Constitution authorizes the Parliament to form new states and alter the areas, boundaries, or names of existing states through a simple majority.",
    },
    {
      text: "In 1953, Prime Minister Jawaharlal Nehru announced the formation of a Commission to study the reorganization of states on a linguistic basis under the chairmanship of:",
      options: [
        "T.T. Krishnamachari",
        "Vallabhbhai Patel",
        "Fazl Ali",
      ...
      correctAnswer: "Fazl Ali",
      explanation:
        "The States Reorganisation Commission (SRC) was headed by Fazl Ali, with K.M. Panikkar and H.N. Kunzru as its other two members.",
    },
    {
      text: "The Parliament of India passed the States Reorganisation Act in 1956 to create:",
      options: [
      ...
      correctAnswer: "14 States and 6 Union Territories",
      explanation:
        "Based on the recommendations of the Fazl Ali Commission, the 1956 Act led to the creation of 14 states and 6 union territories by merging various existing categories of states.",
    },
    {
      text: "The States of the Indian Union can be reorganised or their boundaries altered by:",
      options: [
      ...
      correctAnswer:
        "The Union Parliament by a simple majority in the ordinary process of legislation.",
      explanation:
        "Alteration of state boundaries under Article 3 is not considered an amendment of the Constitution under Article 368; therefore, it requires only a simple majority.",
    },
    {
      text: "The Constitution of India divided the states of India in categories A, B, C and D in the year 1950. In this context which of the following statements is correct?",
      options: [
      ...
      correctAnswer:
        "The Governor was the executive head of category A states. The Rajpramukh was the executive head of category B states. The Chief Commissioner was the executive head of categories C and D states.",
      explanation:
        "Part A states were former British provinces (Governor-led), Part B were former Princely States (Rajpramukh-led), and Part C/D were administered by Chief Commissioners or Lieutenant Governors.",
    },
    {
      text: "Who among the following was the head of the Linguistic Provinces Commission appointed in the year 1948, to enquire into the desirability of linguistic provinces?",
      options: [
        "Jawaharlal Nehru",
        "Justice S.K. Dhar",
        "Justice Fazl Ali",
      ...
      correctAnswer: "Justice S.K. Dhar",
      explanation:
        "The Dhar Commission was appointed in June 1948 and recommended that reorganization should be based on administrative convenience rather than linguistic factors.",
    },
    {
      text: "What is the correct chronological order in which the following States of the Indian Union were created or granted full statehood?\n1. Andhra Pradesh\n2. Nagaland\n3. Maharashtra\n4. Haryana",
      options: ["1-3-4-2", "3-1-2-4", "1-3-2-4", "3-1-4-2"],
      correctAnswer: "1-3-2-4",
      explanation:
        "Andhra Pradesh was created in 1953, Maharashtra in 1960, Nagaland in 1963, and Haryana in 1966.",
    },
    {
      text: "Who, among the following, was not a member of the States Reorganisation Commission (SRC) appointed by Pandit Jawaharlal Nehru ?",
      options: [
        "Justice Fazl Ali",
        "Potti Sriramulu",
        "K.M. Panikkar",
      ...
      explanation:
        "Potti Sriramulu was a Gandhian leader who died after a 56-day hunger strike for a separate Andhra state. He was not a member of the commission itself.",
    },
    {
      text: "Consider the following statements with reference to the linguistic reorganisation of states in independent India:\n1. The separate state of Andhra for the Telugu people came into existence in 1953.\n2. Jawaharlal Nehru was particularly in favour of the movement for linguistic reorganisation of states that came in the wake of the success of the Andhra movement.",
      options: ["Only 1", "Only 2", "Both 1 and 2", "Neither 1 nor 2"],
      correctAnswer: "Only 1",
      explanation:
        "While Andhra was created in 1953, Nehru and other top leaders were initially hesitant about linguistic reorganization, fearing it might threaten national unity.",
    },
    {
      text: "Match List I with List II and select the correct answer using the codes given below:\nList-I (State): A. Goa, B. Haryana, C. Meghalaya, D. Sikkim\nList-II (Year): 1. 1966, 2. 1972, 3. 1976, 4. 1987",
      options: ["3 1 2 4", "4 2 1 3", "3 2 1 4", "4 1 2 3"],
      correctAnswer: "4 1 2 3",
      explanation:
        "Haryana became a state in 1966, Meghalaya in 1972, Sikkim in 1975 (with the 1976 date often used for full administrative integration), and Goa in 1987.",
    },
  ],
  Citizenship: [
    {
      ...
      correctAnswer: "Both 1 and 2",
      explanation:
        "Under the 1955 Act, citizenship by descent was available for children born abroad to Indian fathers. After 1987, citizenship by birth required at least one parent to be an Indian citizen.",
    },
    {
      text: "Under the Citizenship Act, 1955, by which of the following ways can a person become a citizen of India?\n1. By birth\n2. By descent\n3. By registration\n4. By nationalisation\n5. By incorporation of territory",
      options: ["1, 2, 3, 4 and 5", "1 and 2", "1, 2, 3 and 5", "3, 4 and 5"],
      correctAnswer: "1, 2, 3 and 5",
      explanation:
        "The Act specifies five ways: Birth, Descent, Registration, Naturalisation, and Incorporation of Territory. 'Nationalisation' is an incorrect term used here, which is why option 4 is excluded from the correct set.",
    },
    {
      text: "Which of the following Articles of the Indian Constitution deal with citizenship in India?",
      options: [
        "Articles 333 to 337",
        "Articles 17 to 20",
        "Articles 5 to 11",
      ...
      correctAnswer: "Articles 5 to 11",
      explanation:
        "Part II of the Indian Constitution contains Articles 5 through 11, which describe who was considered a citizen at the commencement of the Constitution and empower Parliament to regulate citizenship laws.",
    },
    {
      text: "In which of the following years, the Citizenship Act, 1955 has been amended?\n1. 1986\n2. 1992\n3. 2003\n4. 2005",
      options: ["2, 3 and 4", "1, 2 and 4", "1, 2, 3 and 4", "1, 2 and 3"],
      correctAnswer: "1, 2, 3 and 4",
      explanation:
        "The Act has undergone multiple significant amendments in 1986, 1992, 2003, 2005, and later in 2015 and 2019 to adapt to changing socio-political needs.",
    },
    {
      text: "Which Article of the Constitution of India deals with the rights of citizenship of certain persons of Indian origin residing outside India?",
      options: ["Article 7", "Article 10", "Article 8", "Article 9"],
      correctAnswer: "Article 8",
      explanation:
        "Article 8 provides for citizenship rights to persons of Indian origin (PIOs) residing outside undivided India, provided they register themselves with the Indian diplomatic mission.",
    },
    {
      text: "Which one among the following has the power to regulate the right of citizenship in India?",
      options: [
        "The Union Cabinet",
        "The Parliament",
        "The Supreme Court",
      ...
      explanation:
        "Article 11 gives the Parliament the absolute power to make any provision with respect to the acquisition and termination of citizenship.",
    },
    {
      text: "In which Part of the Constitution, details of citizenship are mentioned?",
      options: ["Part I", "Part II", "Part III", "Part IV"],
      correctAnswer: "Part II",
      explanation:
        "Part II covers Citizenship. For context, Part I covers Union and its Territory, Part III covers Fundamental Rights, and Part IV covers Directive Principles of State Policy.",
    },
    {
      text: "Match List I with List II:\nA. Migration from Pak to India - 3. Article 6\nB. Foreign state citizenship (voluntarily) - 5. Article 9\nC. Citizenship at commencement - 1. Article 5\nD. Migration to Pakistan - 2. Article 7",
      options: ["3 4 2 5", "2 5 3 1", "2 4 1 3", "3 5 1 2"],
      correctAnswer: "3 5 1 2",
      explanation:
        "Article 5 is about commencement, 6 covers incoming migrants from Pakistan, 7 covers migrants to Pakistan, and 9 states that obtaining foreign citizenship automatically ends Indian citizenship.",
    },
    {
      text: "According to the Citizenship Act, 1955, by which of the following ways can a person lose citizenship of India?\n1. By Renunciation\n2. By Termination\n3. By Deprivation",
      options: ["1 and 2", "2 and 3", "1, 2 and 3", "1 and 3"],
      correctAnswer: "1, 2 and 3",
      explanation:
        "Loss of citizenship happens by Renunciation (voluntary), Termination (obtaining foreign citizenship), or Deprivation (compulsory termination by the government for fraud/disloyalty).",
    },
    {
      ...
      correctAnswer: "Only 1",
      explanation:
        "While the 1955 Act did include Commonwealth citizenship, it was actually repealed by the Citizenship (Amendment) Act of 2003, not 2005.",
    },
  ],
  Fundamental_Rights: [
    {
      ...
      explanation:
        "Article 20(3) protects against self-incrimination, which applies specifically to oral or written testimony. The Supreme Court has ruled that giving physical evidence like thumb impressions or signatures for identification is not a violation of this right.",
    },
    {
      ...
      correctAnswer: "Both 1 and 2",
      explanation:
        "Mandamus is a command to any public authority to perform a duty they have failed to do. Prohibition is a preventive writ issued specifically to lower courts or tribunals to stop them from exceeding their jurisdiction.",
    },
    {
      ...
      correctAnswer: "Only 2",
      explanation:
        "Statement 1 is incorrect because Article 16(4A) provides for reservations in promotions for SCs and STs. Statement 2 is correct as it reflects the criteria defined in Article 16(4).",
    },
    {
      ...
      correctAnswer: "Only 1",
      explanation:
        "In the I.R. Coelho case, the Supreme Court ruled that laws added to the Ninth Schedule after 1973 are open to judicial review for basic structure violations. Any legislation, not just amendments, can be challenged on basic structure grounds.",
    },
    {
      text: "Which one of the following pairs is not correctly matched?",
      options: [
      ...
      correctAnswer:
        "Right to personal liberty : Include the right to carry on any trade or business",
      explanation:
        "The right to carry on a trade or business is protected under Article 19(1)(g), not Article 21 (Personal Liberty). Article 21 focuses on life and physical liberty.",
    },
    {
      text: "Assertion (A): The principle of equality before law means that there should be equality of treatment under equal circumstances.\nReason (R): All persons are not equal by nature, attainment or circumstances.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer:
        "Both A and R are individually true and R is the correct explanation of A",
      explanation:
        "Equality before law implies 'like should be treated alike'. Since people exist in different circumstances, the law allows for reasonable classification to ensure substantive equality.",
    },
    {
      ...
      options: ["1 and 2", "1 and 3", "2, 3 and 4", "1 and 4"],
      correctAnswer: "1 and 4",
      explanation:
        "The Right Against Exploitation consists of Articles 23 and 24. Abolition of untouchability is Article 17, and protection of minorities falls under Articles 29 and 30.",
    },
    {
      text: "Match List I (Writs) with List II (Ground):\nA. Habeas Corpus - 2. Unlawful detention\nB. Mandamus - 1. Non-performance of public duties\nC. Quo-Warranto - 4. Unlawful occupation of public office\nD. Certiorari - 3. Correctional directions to subordinate courts",
      options: [
        "A-3, B-4, C-1, D-2",
        "A-2, B-1, C-4, D-3",
        "A-3, B-1, C-4, D-2",
      ...
      correctAnswer: "A-2, B-1, C-4, D-3",
      explanation:
        "Habeas Corpus deals with illegal detention; Mandamus commands a duty; Quo-Warranto questions the legality of holding office; Certiorari corrects errors of jurisdiction in lower courts.",
    },
    {
      text: "As far as the Armed Forces are concerned, the Fundamental Rights granted under Articles 14 and 19 of Constitution are:",
      options: [
        "Not available at all",
        "Available to the Armed Forces but not to other forces",
        "Available only at the discretion of the Chief of the Army staff",
        "Available only according to law made by Parliament",
      ],
      correctAnswer: "Available only according to law made by Parliament",
      explanation:
        "Article 33 empowers the Parliament to modify or restrict the fundamental rights of members of the armed forces to ensure discipline and proper discharge of duties.",
    },
    {
      text: "In Indian Constitution, the power to issue a writ of 'Habeas Corpus' is vested only in:",
      options: [
        "The Supreme Court",
        "The High Courts",
      ...
      correctAnswer: "The Supreme Court and the High Courts",
      explanation:
        "Writ jurisdiction for Fundamental Rights is granted to the Supreme Court under Article 32 and to High Courts under Article 226.",
    },
    {
      text: "Which of the following rights is not explicitly mentioned in the Fundamental Rights but has been upheld to be so by several pronouncements of the Supreme Court?",
      options: [
        "Equity before law",
        "Right to non-discrimination in public employment",
        "Right to form associations or unions",
        "Right to freedom of Press",
      ],
      correctAnswer: "Right to freedom of Press",
      explanation:
        "The freedom of the Press is not explicitly mentioned but is interpreted by the judiciary as being an integral part of the freedom of speech and expression under Article 19(1)(a).",
    },
    {
      text: "Which of the following statements are true with regard to the Fundamental Rights of the minorities in educational matters?\n1. The minority has only the right to administer the educational institutions.\n2. The minority has the right to establish and administer educational institutions.\n3. The right is absolute and not subject to any restriction.\n4. Reasonable restrictions may be imposed to promote efficiency and prevent maladministration.",
      options: ["1, 2 and 3", "2 and 4", "2, 3 and 4", "1 and 3"],
      correctAnswer: "2 and 4",
      explanation:
        "Article 30 gives minorities the right to both establish and administer institutions. While the right is broad, the State can impose reasonable regulations for educational standards and administrative efficiency.",
    },
    {
      text: "Which one of the following pairs is not correctly matched?",
      options: [
        "Article 15 : Special provisions for socially and educationally backward classes",
        "Article 22 : Safeguards under Preventive Detention",
        "Article 20 : Immunity from double punishment",
        "Article 16 : Discrimination in favour of women in service under the State",
      ],
      correctAnswer:
        "Article 16 : Discrimination in favour of women in service under the State",
      explanation:
        "Special provisions for women (affirmative discrimination) are allowed under Article 15(3). Article 16 deals with non-discrimination and reservations for backward classes in public employment.",
    },
    {
      text: "Which of the following statements is/are correct of the writ of prohibition?\n1. It is an order issued by a higher court commanding a lower court to cease from proceeding in some matters not within its jurisdiction.\n2. It can be claimed by an aggrieved party as a matter of right.",
      options: ["Only 1", "Only 2", "Both 1 and 2", "Neither 1 nor 2"],
      correctAnswer: "Both 1 and 2",
      explanation:
        "Prohibition is a preventive writ issued to a lower court to stop it from acting beyond its jurisdiction. It is usually considered a matter of right when the lack of jurisdiction is apparent.",
    },
    {
      text: "Match List I (Provisions) with List II (Contained In):\nA. Liberty of thought and expression - 3. Preamble\nB. Freedom of speech and expression - 1. Right to freedom\nC. Making special provision for women and children - 5. Right to equality\nD. Protection of interest of Minorities - 2. Cultural and educational rights",
      options: [
        "A-3, B-1, C-5, D-2",
        "A-2, B-5, C-4, D-1",
        "A-3, B-5, C-4, D-2",
      ...
      correctAnswer: "A-3, B-1, C-5, D-2",
      explanation:
        "Liberty of thought/expression is in the Preamble. Freedom of speech is Art 19. Special provisions for women is Art 15 (Right to Equality). Minority interests are protected in Art 29.",
    },
    {
      text: "Under the Indian Constitution, which one of the following is not a specific ground on which the State can place restrictions on freedom of religion?",
      options: ["Public order", "Morality", "Social Justice", "Health"],
      correctAnswer: "Social Justice",
      explanation:
        "Articles 25 and 26 subject religious freedom to public order, morality, and health. 'Social Justice' is a general constitutional goal but not an explicitly listed ground for religious restriction.",
    },
    {
      text: "The scope of life and personal liberty', as envisaged in Article 21 of the Constitution of India, has expanded considerably over the years.\nWhich one of the following can still not be subject of this protection?",
      options: [
      ...
      correctAnswer:
        "The Right, under a settlement, to claim bonus or dearness allowance",
      explanation:
        "Claiming bonuses or dearness allowance is a contractual or statutory labor right, not a fundamental right protected under the expansive interpretation of Article 21 (Right to Life).",
    },
    {
      text: "Assertion (A): Preventive Detention is included in the chapter on Fundamental Rights in the Constitution of India.\nReason (R): The Constitution has vested the legislative power with regard to preventive detention in the Parliament only and the State Legislatures have no authority in this regard.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      explanation:
        "While Preventive Detention is in Part III, the legislative power is concurrent. Both Parliament and State Legislatures can make laws for preventive detention for reasons connected with the security of a state, maintenance of public order, etc.",
    },
    {
      text: "Which of the following is not included in Article 19 of the Constitution of India, pertaining to the Right to Freedom?",
      options: [
      ...
      correctAnswer:
        "Right of minorities to establish and administer educational institutions",
      explanation:
        "Minority educational rights are provided under Article 30, whereas Article 19 lists six specific democratic freedoms for citizens.",
    },
    {
      ...
      correctAnswer: "1, 2 and 3",
      explanation:
        "Article 12 defines 'State' broadly to include the Union and State governments, legislatures, local bodies, and other statutory/non-statutory bodies acting as an arm of the government.",
    },
    {
      text: "Which one of the following rights was described by Dr. Ambedkar as 'the heart and soul' of the Constitution?",
      options: [
        "Right to equality",
      ...
      explanation:
        "Dr. Ambedkar considered Article 32 vital because it makes other fundamental rights real and enforceable through judicial intervention.",
    },
    {
      text: "Which one of the following freedoms is not guaranteed by the Constitution of India?",
      options: [
      ...
      correctAnswer: "Freedom to own, acquire and dispose of property",
      explanation:
        "The right to property was removed as a fundamental right by the 44th Amendment Act (1978) and is now only a legal right under Article 300A.",
    },
    {
      text: "Assertion (A): One of the fundamental principles of the Indian Constitution is the Rule of Law.\nReason (R): The Constitution of India has guaranteed to every citizen the equality before law and has recognized the judiciary as the unfailing guardian of the rights of people.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer:
        "Both A and R are individually true and R is the correct explanation of A",
      explanation:
        "The Rule of Law is a basic feature of the Constitution, upheld by ensuring equality before law (Art 14) and providing judicial remedies (Art 32/226) to protect those rights.",
    },
    {
      text: "Match List I (Cases) with List II (Related to):\nA. Indra Sawhney Case - 3. Reservation for Backward Classes\nB. Minerva Mills Case - 4. Revival of Judicial Review\nC. Gopalan Case - 2. Procedure Established by Law\nD. Shankari Prasad Case - 1. Power of Parliament to amend Part III of the Constitution upheld",
      options: [
        "A-3, B-1, C-2, D-4",
        "A-2, B-4, C-3, D-1",
        "A-3, B-4, C-2, D-1",
      ...
      explanation:
        "Indra Sawhney (1992) is the Mandal case. Minerva Mills (1980) limited the power to amend and revived judicial review. A.K. Gopalan (1950) was about Art 21. Shankari Prasad (1951) first upheld the power to amend fundamental rights.",
    },
    {
      text: "Which one of the following is the correct statement?\nRight to privacy as a Fundamental Right is implicit in:",
      options: [
      ...
      correctAnswer: "The Right to Personal Liberty",
      explanation:
        "The Supreme Court (Puttaswamy case) has declared that the Right to Privacy is a fundamental right implicit in Article 21 (Life and Personal Liberty).",
    },
    {
      text: "Assertion (A): An accused person cannot be compelled to give his thumb impression.\nReason (R): An accused person cannot be compelled to be a witness against himself.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer: "A is false but R is true",
      explanation:
        "The protection against self-incrimination in Article 20(3) only covers testimonial evidence. Compelling an accused to give physical evidence like thumb impressions is legally permissible.",
    },
    {
      text: "Right to Education is a fundamental right emanating from right to:",
      options: [
        ...
        "Equality before law and equal protection of the laws under Article 14",
      ],
      correctAnswer: "Life and personal liberty under Article 21",
      explanation:
        "The Right to Education (Art 21A) was added following judicial observations that life (Art 21) cannot be lived with dignity without education.",
    },
    {
      text: "The State shall not make any law which takes away or abridges the fundamental rights. Which one of the following shall not be construed as law for this purpose?",
      options: ["Ordinance", "Bye-law", "Rule", "Constitutional amendment"],
      correctAnswer: "Constitutional amendment",
      explanation:
        "In the Kesavananda Bharati case, the Supreme Court held that 'Law' in Article 13 refers to ordinary laws, and Parliament has the power to amend fundamental rights through a Constitutional Amendment, provided it doesn't violate the Basic Structure.",
    },
    {
      text: "On which one of the following freedoms, can reasonable restrictions be imposed on the ground of the security of the state?",
      options: [
      ...
      correctAnswer: "Speech and expression",
      explanation:
        "Article 19(2) allows the State to impose reasonable restrictions on the freedom of speech and expression specifically in the interests of the security of the state.",
    },
    {
      text: "Which of the following are mentioned under separate Articles in Part III of the Constitution of India pertaining to Fundamental Rights?\n1. Abolition of untouchability\n2. Abolition of titles\n3. Freedom as to payment of taxes for promotion of any particular religion\n4. Protection of interests of minorities",
      options: ["1 and 2", "2, 3 and 4", "3 and 4", "1, 2, 3 and 4"],
      correctAnswer: "1, 2, 3 and 4",
      explanation:
        "All four are distinct articles: Untouchability (17), Titles (18), Tax for religion (27), and Minority interests (29).",
    },
    {
      text: "Fundamental rights guaranteed in the Indian Constitution can be suspended only by:",
      options: [
      ...
      correctAnswer: "A proclamation of national emergency",
      explanation:
        "Fundamental rights (except Art 20 & 21) can be suspended during a National Emergency under the provisions of Articles 358 and 359.",
    },
    {
      text: "The Right to Property was converted into a legal right from a Fundamental Right, because it:",
      options: [
      ...
      correctAnswer:
        "Led to severe conflict between judiciary and the Parliament",
      explanation:
        "The right to property led to major legal battles over land reforms and compensation, causing a long-running tussle between the executive/legislature and the judiciary.",
    },
    {
      text: "Match List I (Writ) with List II (Purpose):\nA. Writ of mandamus - 2. Direction to the official for the performance of a duty\nB. Writ of injunction - 1. Prohibition of an action\nC. Writ of certiorari - 4. Transferring of a case from lower court to a court of higher jurisdiction\nD. Writ of quo-warranto - 3. Trial of the right to a title or elective office",
      options: [
        "A-2, B-1, C-4, D-3",
        "A-1, B-2, C-3, D-4",
        "A-3, B-4, C-2, D-1",
      ...
      correctAnswer: "A-2, B-1, C-4, D-3",
      explanation:
        "Mandamus is an order to act; Injunction (Prohibition) is an order to stop; Certiorari transfers or quashes cases; Quo-Warranto checks the authority to hold office.",
    },
    {
      text: "Under Article 22 of the Constitution of India, with the exception of certain provisions stated therein, what is the maximum period for detention of a person under preventive detention?",
      options: ["2 months", "3 months", "4 months", "6 months"],
      correctAnswer: "3 months",
      explanation:
        "Article 22(4) states that no person shall be detained under preventive detention for more than 3 months without the approval of an advisory board.",
    },
    {
      text: "Which one of the following Fundamental Rights is guaranteed only to the citizens of India and not to the foreigners living in India?",
      options: [
      ...
      correctAnswer: "Freedom of speech and expression",
      explanation:
        "Rights under Article 19 (Freedoms), 15, 16, 29, and 30 are available exclusively to Indian citizens.",
    },
    {
      text: "The Supreme Court has increased the ambit of the Right to Life (Article 21) to include which of the following?\n1. Right to life includes the Right to live with dignity\n2. Right to life includes the Right to livelihood\n3. Right to life includes the Right to receive minimum wages\n4. Right to life includes the Right to guaranteed employment for 100 days in a year",
      options: ["Only 4", "1 and 2", "1, 2 and 3", "1, 2, 3 and 4"],
      correctAnswer: "1 and 2",
      explanation:
        "The judiciary has interpreted 'life' to mean a life with dignity and livelihood. Minimum wages and guaranteed employment are statutory rights, not core fundamental rights derived from Article 21.",
    },
    {
      text: "In accordance with the text of the Constitution, a reasonable restriction in the interest of 'sovereignty and integrity' of India can be imposed on the right to:",
      options: [
        "Freedom of speech and expression",
        "Move freely throughout the territory of India",
        "Reside and settle in any part of the territory",
        "Carry on any occupation, trade or business of India",
      ],
      correctAnswer: "Freedom of speech and expression",
      explanation:
        "The grounds of 'sovereignty and integrity of India' were added to Article 19(2) by the 16th Amendment to allow restrictions on free speech.",
    },
    {
      text: "Which one of the following is the best justification for the affirmative action policies in India?",
      options: [
        "The principle of non-discrimination",
        "The principle of equal opportunity",
        "The principle of group disadvantage",
        "The principle of radical redistribution",
      ],
      correctAnswer: "The principle of equal opportunity",
      explanation:
        "Affirmative action (reservation) is designed to provide 'equal opportunity' in a real sense to those who have been historically marginalized, going beyond formal equality.",
    },
    {
      text: "Assertion (A): The Indian Constitution recognizes the supremacy of judiciary.\nReason (R): The question as to what constitutes a reasonable restriction on fundamental rights is to be determined by the courts of law.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer:
        "Both A and R are individually true and R is the correct explanation of A",
      explanation:
        "The judiciary has the final power to decide if the restrictions imposed by the legislature are 'reasonable' under the Constitution, establishing its supremacy in interpreting rights.",
    },
    {
      text: 'Under the term "Double Jeopardy" implied in Article 20 of the Constitution of India, a person:',
      options: [
        "Convicted by a court of law cannot be punished under departmental proceedings for the same offence.",
        "Punished departmentally cannot be prosecuted in a court of law for the same offence.",
        "Shall not be prosecuted and punished for the same offence more than once.",
        "Cannot be subjected to proceedings in civil courts for disobedience of an injunction along with criminal proceedings.",
      ],
      correctAnswer:
        "Shall not be prosecuted and punished for the same offence more than once.",
      explanation:
        "Double Jeopardy means protection against being tried and punished for the same crime twice. It applies to judicial trials, not administrative or departmental proceedings.",
    },
    {
      text: "Reservation of seats in educational institutions in favour of Scheduled Castes and Scheduled Tribes is governed by:",
      options: [
      ...
      correctAnswer: "Article 15 of the Constitution",
      explanation:
        "Article 15(4) allows for special provisions in education. Article 16 governs reservations in public employment.",
    },
    {
      text: "What is the correct sequence of the following?\n1. Scheduled Castes Order\n2. Untouchability Offences Act\n3. Protection of Civil Rights Act\n4. Scheduled Castes and Scheduled Tribes (Prevention of Atrocities) Act",
      options: ["3, 4, 1, 2", "4, 1, 2, 3", "1, 2, 3, 4", "2, 3, 4, 1"],
      correctAnswer: "1, 2, 3, 4",
      explanation:
        "The SC Order came in 1950, Untouchability Act in 1955 (renamed to Protection of Civil Rights Act in 1976), and the Atrocities Act in 1989.",
    },
    {
      text: "Which one of the following pairs is not correctly matched?",
      options: [
        "Right to Equality : Includes the principle of natural justice",
        "Right to personal liberty : Includes right to livelihood",
        "Protections available to an accused person : Includes protection against ex-post facto laws in civil matters",
        "Protections against arrest and detention : Includes right to consult and to be defended by a legal practitioner of one's choice",
      ],
      correctAnswer:
        "Protections available to an accused person : Includes protection against ex-post facto laws in civil matters",
      explanation:
        "Protection against ex-post facto laws (Art 20) only applies to criminal laws, not to civil or tax laws, which can be retrospective.",
    },
    {
      text: "Which of the following Fundamental Rights cannot be suspended during emergency?",
      options: [
        "Freedoms under Article 19",
        "Right to constitutional remedies under Articles 32 and 226",
        "Rights under Articles 21 and 22",
        "Rights under Articles 20 and 21",
      ],
      correctAnswer: "Rights under Articles 20 and 21",
      explanation:
        "The 44th Amendment Act (1978) ensures that the right to life (Art 21) and protection against retrospective criminal laws (Art 20) cannot be suspended even during an emergency.",
    },
    {
      text: "Assertion (A): Speaking on Article 32 in the Constituent Assembly, Dr. Ambedkar described the Article as the very soul of the Constitution.\nReason (R): Article 32 provides effective remedies against violation of fundamental rights.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer:
        "Both A and R are individually true and R is the correct explanation of A",
      explanation:
        "Dr. Ambedkar considered Article 32 fundamental because it guarantees the enforcement of all other rights, making it the 'soul' of the structure.",
    },
    {
      text: "Which of the following statements about the right to freedom of religion is not correct?",
      options: [
        "The State can regulate the economic, financial, political or other secular activities which may be associated with religious practices.",
      ...
      correctAnswer:
        "Funds appropriated by a religious denomination for promoting and maintaining a particular religion are taxable.",
      explanation:
        "Article 27 specifically states that no person shall be compelled to pay any taxes, the proceeds of which are specifically appropriated in payment of expenses for the promotion or maintenance of any particular religion.",
    },
    {
      text: "Through which provisions does the Constitution of India explicitly prohibits racial discrimination in India?",
      options: [
        "Articles 14 and 17",
        "Articles 17 and 23",
        "Articles 15 and 16",
      ...
      correctAnswer: "Articles 15 and 16",
      explanation:
        "Article 15 prohibits discrimination on grounds of 'race' among others. Article 16 applies this to public employment.",
    },
    {
      text: "Which one of the following rights cannot be inferred from Article 21 of the Constitution?",
      options: [
      ...
      correctAnswer: "Right to form association",
      explanation:
        "The right to form associations is specifically guaranteed under Article 19(1)(c), not Article 21.",
    },
    {
      text: "Which one of the following pairs is correctly matched?",
      options: [
        "Writ of Habeas Corpus : Available against private individuals as well",
      ...
      correctAnswer:
        "Writ of Habeas Corpus : Available against private individuals as well",
      explanation:
        "Habeas Corpus is the only writ that can be issued against both public authorities and private individuals to prevent illegal confinement.",
    },
    {
      text: "Assertion (A): Education is the fundamental right of every child between the age of 6 and 14 years.\nReason (R): The 84th Constitutional Amendment Act provided for right to education.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer: "A is true but R is false",
      explanation:
        "The Right to Education was added by the 86th Constitutional Amendment Act of 2002, not the 84th.",
    },
    {
      text: "Which one of the following Fundamental Rights is available to both the citizens and aliens?",
      options: [
        "The right to equality of opportunity in public employment",
        "The right to freedoms under Article 19",
        "Cultural and educational rights",
        "The right to equality before law",
      ],
      correctAnswer: "The right to equality before law",
      explanation:
        "Article 14 (Equality before law) is available to 'any person', whereas Articles 15, 16, 19, and 30 are only for Indian citizens.",
    },
    {
      text: "Which of the following are not included in the right to freedom of religion in the Constitution of India?\n1. Freedom of conscience and the right to practice and propagate religion\n2. Levying of taxes or use of funds of the Government for the promotion or maintenance of any religion\n3. Establishment and maintenance of religious and charitable institutions\n4. Imparting of religious instruction in any Government maintained institution",
      options: ["1 and 2", "1, 2 and 3", "1, 3 and 4", "2 and 4"],
      correctAnswer: "2 and 4",
      explanation:
        "Article 27 prohibits the use of tax funds for religion. Article 28 prohibits religious instruction in wholly government-funded institutions.",
    },
    {
      text: "Which one of the under mentioned rights is guaranteed to citizens as right to freedom under Article 19?",
      options: [
        "The right to vote",
      ...
      correctAnswer: "The right to assemble peaceably and without arms",
      explanation:
        "Freedom of assembly is one of the six specific democratic freedoms listed under Article 19(1).",
    },
    {
      text: "Assertion (A): In Minerva Mills v. Union of India, Art.31-C as amended by the Constitution (Forty-second Amendment) Act, 1976 was held invalid.\nReason (R): The amendment of Art. 31-C destroyed the basic structure of the Constitution.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer:
        "Both A and R are individually true and R is the correct explanation of A",
      explanation:
        "The 42nd amendment tried to give all DPSP precedence over Fundamental Rights. The SC struck this down, stating it disturbed the balance between Parts III and IV, which is part of the basic structure.",
    },
    {
      text: "Which of the following are the grounds on which discrimination of citizens for admission into educational institutions is constitutionally prohibited?\n1. Religion and Race\n2. Sex and Place of birth\n3. Nationality and Colour\n4. Age and Nativity",
      options: ["1, 2, 3 and 4", "1 and 2", "1, 2 and 3", "1, 2 and 4"],
      correctAnswer: "1 and 2",
      explanation:
        "Article 15 prohibits discrimination on the specific grounds of religion, race, caste, sex, or place of birth. Nationality, age, and nativity are not listed as grounds for prohibition in this article.",
    },
    {
      text: "Which one of the following is the correct association?",
      options: [
        "Indra Sawhney Case : Basic structure of the Constitution",
        "Minerva Mills Case : Invocation of Article 356",
        "Menaka Gandhi Case : Just, fair and reasonable procedure of law",
        "Gopalan Case : Financial Emergency",
      ],
      correctAnswer:
        "Menaka Gandhi Case : Just, fair and reasonable procedure of law",
      explanation:
        "In Menaka Gandhi (1978), the SC ruled that any law depriving personal liberty must not only follow procedure but the procedure itself must be just, fair, and reasonable.",
    },
    {
      text: "Assertion (A): An accused person has been guaranteed the right to be informed of the nature and cause of accusation.\nReason (R): The accused person can get his conviction quashed upon vague and obscure charges.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer:
        "Both A and R are individually true and R is the correct explanation of A",
      explanation:
        "Article 22 mandates informing the accused of grounds of arrest to ensure they can prepare an effective defense. Failure to do so makes the arrest illegal.",
    },
    {
      text: "Match List I (Writ) with List II (Matter in Dispute):\nA. Habeas Corpus - 2. Custody of a child by parents\nB. Mandamus - 4. Refund of money illegally collected as cess by taxing authority\nC. Quo-Warranto - 1. Appointment of a university teacher\nD. Certiorari - 3. Violation of natural justice",
      options: [
        "A-1, B-3, C-2, D-4",
        "A-2, B-4, C-1, D-3",
        "A-1, B-4, C-2, D-3",
      ...
      correctAnswer: "A-2, B-4, C-1, D-3",
      explanation:
        "Habeas Corpus applies to child custody disputes. Mandamus can be used for illegal tax refunds. Quo-Warranto challenges public appointments. Certiorari corrects violations of natural justice in lower courts.",
    },
    {
      text: "Right to life emanates from:",
      options: [
        "Article 21 and includes right to die",
        "Article 19 and does not include right to die",
        "Articles 19 and 20 and does include right to die",
        "Article 21 and does not include right to die",
      ],
      correctAnswer: "Article 21 and does not include right to die",
      explanation:
        "While Article 21 guarantees the right to life, the Supreme Court (Gian Kaur case) confirmed that it does not include the 'right to die'.",
    },
    {
      text: "Which of the following Article (s) of the Constitution of India is/are exceptions to the Fundamental Rights enumerated in Article 14 or Article 19?",
      options: [
        "Article 31 A only",
        "Article 31 C only",
        "Article 31 A and Article 31 C both",
        "Neither Article 31 A nor Article 31 C",
      ],
      correctAnswer: "Article 31 A and Article 31 C both",
      explanation:
        "Articles 31A, 31B, and 31C are saving clauses that protect certain categories of laws (like land reforms or those implementing specific DPSP) from being challenged on the grounds of violating Articles 14 and 19.",
    },
    {
      text: "Assertion (A): Article 14 of the Indian Constitution does not lay down that all laws must be of universal application.\nReason (R): State has power to classify persons for legitimate purpose and on reasonable grounds.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer:
        "Both A and R are individually true and R is the correct explanation of A",
      explanation:
        "Article 14 permits 'reasonable classification' based on intelligible differentia that has a rational nexus with the objective sought to be achieved.",
    },
    {
      text: "For which of the following can special provisions be made under Article 15 of the Constitution of India?\n1. Women and children\n2. Scheduled Tribes\n3. Economically backward classes\n4. Socially backward classes",
      options: ["1, 2 and 4", "1 and 3", "2, 3 and 4", "1, 2, 3 and 4"],
      correctAnswer: "1, 2 and 4",
      explanation:
        "Article 15 specifically mentions special provisions for women/children, and for socially and educationally backward classes (which includes SC/ST). Economically backward was added later via Art 15(6).",
    },
    {
    ...
    },
    {
      ...
      correctAnswer: "A-1, B-2, C-3, D-4",
      explanation:
        "These are the standard definitions of the constitutional writs issued by courts for enforcement of rights.",
    },
    {
      text: "Freedom of the press in India is:",
      options: [
        ...
        "Available to the people of India under executive order",
      ],
      correctAnswer: "Implied in the right to freedom of expression",
      explanation:
        "Though not explicitly named, the Press freedom is considered a part of the fundamental right to speech and expression under Article 19(1)(a).",
    },
    {
      text: "The right to freedom of religion guaranteed in Article 25 of the Constitution of India is subject to which of the following?",
      options: [
        "Public order, morality and to the other provisions of Part III of the Constitution of India",
        "Public order, morality and health",
        "Reasonable restrictions in the interests of the security of the State",
        "Public order, morality and health and to the other provisions of Part III of the Constitution of India.",
      ],
      correctAnswer:
        "Public order, morality and health and to the other provisions of Part III of the Constitution of India.",
      explanation:
        "Article 25 is subject to Public Order, Morality, and Health, AND it is also subject to other fundamental rights in Part III.",
    },
    {
      text: "Which one of the following writs examines the procedures of inferior Courts or Tribunals?",
      options: ["Quo-warranto", "Mandamus", "Prohibition", "Certiorari"],
      correctAnswer: "Certiorari",
      explanation:
        "Certiorari is curative; it examines the records of lower court proceedings to quash orders that suffer from jurisdictional errors or violations of natural justice.",
    },
    {
      text: "The 86th Constitutional Amendment deals with which of the following?",
      options: [
        "Allocation of more number of parliamentary seats for recently created states.",
        "Reservation of 30% posts for women in Panchayati Raj Institutions.",
        "Insertion of Article 21A related with free and compulsory education for all children between the age of 6 and 14 years.",
        "Continuation of reservation for backward classes in government employment.",
      ],
      correctAnswer:
        "Insertion of Article 21A related with free and compulsory education for all children between the age of 6 and 14 years.",
      explanation:
        "The 86th Amendment (2002) made the right to education a fundamental right for children aged 6 to 14.",
    },
    {
      text: "The Article of the Constitution which automatically becomes suspended on proclamation of emergency is :",
      options: ["Article 14", "Article 19", "Article 21", "Article 32"],
      correctAnswer: "Article 19",
      explanation:
        "Under Article 358, the freedoms guaranteed by Article 19 are automatically suspended when a National Emergency is declared on the grounds of war or external aggression.",
    },
    {
      text: "Which one of the following rights conferred by the Constitution of India is also available to non-citizens ?",
      options: [
      ...
      correctAnswer: "Equality before law and equal protection of laws",
      explanation:
        "Article 14 is available to all persons. The other options list freedoms under Article 19 which are reserved for citizens only.",
    },
    {
      text: "Which one of the following writs is issued by an appropriate judicial authority/body to free a person who has been illegally detained?",
      options: ["Quo-warranto", "Mandamus", "Certiorari", "Habeas Corpus"],
      correctAnswer: "Habeas Corpus",
      explanation:
        "Habeas Corpus (to have the body) is the primary protection against arbitrary and illegal arrest or detention.",
    },
    {
      text: "Untouchability has been abolished by the Constitution of India under:",
      options: ["Article 14", "Article 15", "Article 16", "Article 17"],
      correctAnswer: "Article 17",
      explanation:
        "Article 17 abolished untouchability and forbade its practice in any form, making it a punishable offense.",
    },
    {
      text: "Which of the following Constitutional Amendments have added Article 15(5) in the Constitution of India providing for reservation in educational institutions in the private sector also ?",
      options: [
        "81st Amendment",
        "86th Amendment",
        "91st Amendment",
      ...
      explanation:
        "The 93rd Amendment (2005) enabled the state to make special provisions for the advancement of backward classes/SC/ST in educational institutions, including private unaided ones.",
    },
    {
      text: "The writ of certiorari is issued by a superior court to:",
      options: [
        ...
        "An officer to show his right to hold a particular office",
        "A public authority to produce a person detained by it before the court within 24 hours",
      ],
      correctAnswer:
        "An inferior court to transfer the record of proceedings in a case for review",
      explanation:
        "Certiorari is issued to quash the order of a lower court by reviewing the record of the case.",
    },
    {
      text: "Which one of the following statements is not correct?",
      options: [
        "Right to livelihood is an integral facet of the Right to life",
        "Natural justice is implicit in Article 21",
        "The Right to life includes the Right to health",
        "Right to go abroad is not a Fundamental Right under Article 21",
      ],
      correctAnswer:
        "Right to go abroad is not a Fundamental Right under Article 21",
      explanation:
        "In the Menaka Gandhi case, the Supreme Court clearly established that the right to travel abroad is part of the personal liberty protected by Article 21.",
    },
    {
      text: "Which one of the following is the correct statement ?\nThe writ of Mandamus can be issued:",
      options: [
        "Against the legislature for making law",
        "For performance of a public duty",
        "For exercise of discretionary powers",
        "For deciding legality of an arrest",
      ],
      correctAnswer: "For performance of a public duty",
      explanation:
        "Mandamus is a writ issued to a public official or body commanding the performance of a mandatory legal duty.",
    },
    {
      text: "According to the Constitution of India, which one of the following rights cannot be taken away during emergency ?",
      options: [
        "Right to speak",
      ...
      explanation:
        "Post the 44th Amendment, the right to life and personal liberty (Art 21) remains enforceable even during a National Emergency.",
    },
    {
      text: "The right to property was removed from the list of Fundamental Rights enlisted in the Constitution through which one of the following Amendments ?",
      options: [
        "73rd Amendment",
        "23rd Amendment",
        "44th Amendment",
      ...
      explanation:
        "The 44th Amendment Act (1978) abolished the fundamental right to property, making it a mere legal right.",
    },
    {
      text: "Match List I (Writs) with List II (Meanings):\nA. Habeas Corpus - 4. Produce the body of a person\nB. Mandamus - 3. Command to perform public duty\nC. Certiorari - 2. Certified or to be made certain\nD. Quo-Warranto - 1. What warrant or authority",
      options: [
        "A-4, B-3, C-2, D-1",
        "A-3, B-4, C-2, D-1",
        "A-4, B-3, C-1, D-2",
      ...
      correctAnswer: "A-4, B-3, C-2, D-1",
      explanation:
        "These correspond to the literal Latin meanings of the writs.",
    },
    {
      text: "Under the provisions of the Indian Constitution, a community can be declared a minority community on the basis of:",
      options: [
        "Religion only",
        "Either religion or language",
        "Either language or caste",
        "Either religion or race",
      ],
      correctAnswer: "Either religion or language",
      explanation:
        "Article 30 recognizes minorities based on religion or language.",
    },
    {
      text: "Article 30 of the Indian Constitution deals with the:",
      options: [
        "Freedom of conscience",
        "Right to propagate religion",
        "Right of minorities to establish and manage educational institutions",
        "Cultural and educational rights of the majority community",
      ],
      correctAnswer:
        "Right of minorities to establish and manage educational institutions",
      explanation:
        "This article protects the right of all minorities to establish and administer educational institutions of their choice.",
    },
    {
      text: "The 93rd amendment to the Constitution of India deals with:",
      options: [
        "Right to education",
        "Rights in respect of physically handicapped persons for appointments in the services under the state",
      ...
      correctAnswer: "Reservation for admission in educational institutions",
      explanation:
        "It allowed for reservations for OBCs in higher educational institutions.",
    },
    {
      text: 'The Supreme Court of India declared by issuing a writ that "the respondent was not entitled to an office he was holding or a privilege he was exercising".\nWhich writ is that?',
      options: ["Habeas Corpus", "Prohibition", "Quo-Warranto", "Certiorari"],
      correctAnswer: "Quo-Warranto",
      explanation:
        "Quo-Warranto is used to challenge the legality of a person's claim to a public office.",
    },
    {
      text: "When emergency under Article 352 of the Constitution is proclaimed, the President of India has no power to suspend the Fundamental Rights contained in which of the following Articles ?",
      options: ["20 and 21", "19 and 20", "21 and 22", "19 and 21"],
      correctAnswer: "20 and 21",
      explanation:
        "Articles 20 and 21 cannot be suspended under any circumstances according to Article 359.",
    },
    {
      text: "Which one of the following is not covered under Article 20 of the Constitution of India?",
      options: [
        "Ex post facto laws",
      ...
      correctAnswer: "Preventive detention",
      explanation:
        "Article 20 covers protection against ex-post facto laws, double jeopardy, and self-incrimination. Preventive detention is governed by Article 22.",
    },
  ],
  "Directive Principles of State Policy": [
    {
      text: "Which of the following statements about a uniform civil code is/are correct?\n1. It is binding on the State that a uniform civil code must be made applicable to all.\n2. The provision regarding a uniform civil code is contained in Part III of the Constitution.",
      options: ["Only 1", "Only 2", "Both 1 and 2", "Neither 1 nor 2"],
      correctAnswer: 3,
      explanation:
        "Article 44 (Uniform Civil Code) is a Directive Principle under Part IV, not Part III. Unlike Fundamental Rights, Directive Principles are not legally binding or enforceable by the courts.",
    },
    {
      text: "Directive Principles of State Policy direct the State for which of the following?\n1. To secure a social order for the promotion of welfare of the people\n2. To separate judiciary from executive\n3. To improve public health",
      options: ["1 and 2", "2 and 3", "1 and 3", "1, 2 and 3"],
      correctAnswer: 3,
      explanation:
        "These are explicitly mentioned in Article 38 (social order), Article 50 (separation of judiciary), and Article 47 (public health).",
    },
    {
      ...
      options: ["Only 1", "2 and 3", "Only 3", "1, 2 and 3"],
      correctAnswer: 3,
      explanation:
        "DPSPs are moral and political guidelines for the State. While they are fundamental in governance, they cannot be enforced in a court of law if violated.",
    },
    {
      text: "Which of the following statements about the changes made by the forty second amendment to the Constitution relating to the Directive Principles of State Policy are correct?\n1. It enabled State to provide free legal aid to its citizens.\n2. It provided for the State to secure the participation of workers in the management of undertakings.\n3. It required the state to minimise inequalities in income and status.",
      options: ["1 and 2", "1 and 3", "2 and 3", "1, 2 and 3"],
      correctAnswer: 0,
      explanation:
        "The 42nd Amendment added Article 39A (Free Legal Aid) and Article 43A (Participation of Workers). Statement 3 regarding minimizing inequalities was added by the 44th Amendment in 1978.",
    },
    {
      text: "Which one of the following is the real guiding factor for the State to meet social needs and for the establishment of new social order?",
      options: [
        "Fundamental Rights",
      ...
      correctAnswer: 2,
      explanation:
        "The Directive Principles are specifically designed as the State's roadmap for social and economic democracy.",
    },
    {
      text: "Which one of the following is not stated as a Directive Principle of State Policy in the Constitution of India?",
      options: [
      ...
      correctAnswer: 3,
      explanation:
        "The right of minorities to establish educational institutions is a Fundamental Right under Article 30, not a Directive Principle.",
    },
    {
      text: "Assertion (A): The Directive Principles of State Policy contained in the Constitution of India are relevant in determining the limits of reasonable restrictions laid down in Article 19 dealing with the Fundamental Right to Freedom.\nReason (R): The Fundamental Rights in Part III of the Constitution have been superseded by the Directive Principles.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer: 2,
      explanation:
        "While DPSPs help courts determine the 'reasonableness' of restrictions on rights, Fundamental Rights have not been entirely superseded; there is a doctrine of harmonious construction.",
    },
    {
      text: "Though the Directive Principles of State Policy contained in the Constitution are not enforceable by any court, yet they are:",
      options: [
        "Fundamental in the governance of the country",
        "Binding on the State",
        "Enforceable at the instance of the President",
        "Superior to Fundamental Rights of India",
      ],
      correctAnswer: 0,
      explanation:
        "Article 37 explicitly states that these principles are fundamental in the governance of the country and it is the duty of the State to apply them in making laws.",
    },
    {
      text: "Which of the following are included in the Directive Principles of State Policy in the Constitution of India?\n1. Uniform civil code for the citizens\n2. Separation of judiciary from executive\n3. Protection of monuments of national importance",
      options: ["1 and 2", "2 and 3", "1 and 3", "1, 2 and 3"],
      correctAnswer: 3,
      explanation:
        "All three are included: Article 44 (UCC), Article 50 (Judiciary/Executive separation), and Article 49 (Monuments).",
    },
    {
      text: "With respect to the Directive Principles of State Policy, which one of the following pairs is not correctly matched?",
      options: [
        "Just and humane conditions of work: Article 42",
        "Organise village Panchayats: Article 40",
        "Improvement of public health: Article 47",
        "Protect monuments: Article 50",
      ],
      correctAnswer: 3,
      explanation:
        "Protection of monuments is Article 49. Article 50 deals with the separation of the judiciary from the executive.",
    },
    {
      text: "Which one of the following is not a Directive Principle of State Policy?",
      options: [
        "State shall endeavour to secure a uniform civil code",
        "State shall promote interests of weaker sections",
        "State shall endeavour to promote adult education",
        "State shall endeavour to protect every monument",
      ],
      correctAnswer: 2,
      explanation:
        "Promoting adult education to eliminate illiteracy is not specifically worded as a DPSP, although Article 45 and 46 touch upon education and weaker sections.",
    },
    {
      text: "Which one of the following is not the objective of the Directive Principles of State Policy?",
      options: [
      ...
      correctAnswer: 2,
      explanation:
        "The Indian Constitution aims for a secular state; establishing a religious state (theocratic) is contrary to its basic structure.",
    },
    {
      text: "Assertion (A): The directive principles of state policy are not enforceable by any court.\nReason (R): The directive principles are more or less fundamental in the governance of the country.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer: 1,
      explanation:
        "Both statements are correct based on Article 37, but the fact that they are fundamental is not the reason *why* they are non-enforceable (their non-enforceability was a deliberate choice of the makers due to lack of resources).",
    },
    {
      text: "Which one of the following is a correct statement?",
      options: [
        "Primacy is given to all directive principles over fundamental rights",
        "Primacy is given to all fundamental rights (14-32) over directive principles",
        "Primacy is given to all Part III rights over directive principles",
        "Primacy is given only to Article 39(b) and (c) over Articles 14 and 19",
      ],
      correctAnswer: 3,
      explanation:
        "Following the Minerva Mills case and subsequent interpretations, only Article 39(b) and 39(c) are given precedence over Article 14 and 19.",
    },
    {
      text: "Which one of the following Directive Principles was not originally provided for in the Constitution of India?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Free legal aid (Article 39A) was added by the 42nd Amendment Act in 1976.",
    },
    {
      text: "The term 'equal pay for equal work' is a:",
      options: [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Both statements are true. Article 48 deals with animal husbandry and cow slaughter. However, cattle protection is not the reason why India is secular.",
    },
    {
      text: "Which one of the following is not a Directive Principle of State Policy?",
      options: [
        "Organisation of Village Panchayats",
        "Uniform Civil Code for citizens as well as non-citizens",
        "Right to work, education and public assistance",
        "Participation of workers in management of industries",
      ],
      correctAnswer: 1,
      explanation:
        "The Uniform Civil Code (Article 44) is intended for *citizens* only, not non-citizens.",
    },
    {
      text: '"Directive Principles of State Policy are the conscience of the Constitution which embody the social philosophy of the Constitution" was described by:',
      options: [
        "Granville Austin",
        "A.V. Dicey",
        "Dr. B.R. Ambedkar",
      ...
      correctAnswer: 0,
      explanation:
        "Granville Austin described Fundamental Rights and Directive Principles together as the 'Conscience of the Constitution'.",
    },
    {
      text: "Which part of the Constitution of India refers to the responsibility of the state towards international peace and security?",
      options: [
        "Fundamental Rights",
        "Directive Principles of State Policy",
      ...
      correctAnswer: 1,
      explanation:
        "Article 51, the last Directive Principle, mandates the State to promote international peace and security.",
    },
    {
      text: "Which of the following statements is/are correct?\n1. 42nd Amendment gave primacy to Directive Principles over Fundamental Rights.\n2. Minerva Mills case ruled that there has to be a balance between Part III and Part IV.\n3. National Commission for Review of the Working of the Constitution recommended Directive Principles be made justiciable.",
      options: ["1 and 2", "2 and 3", "1 and 3", "2 only"],
      correctAnswer: 0,
      explanation:
        "The 42nd Amendment attempted to give all DPSPs primacy, but the Minerva Mills case (1980) restored the balance and struck down that wide expansion.",
    },
    {
      text: "Assertion (A): Laws covered under Article 39 (b) and (c) have been given protective shield against some fundamental rights.\nReason (R): The Directive Principles are also regarded relevant for considering what are reasonable restrictions under Article 19.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer: 1,
      explanation:
        "Both are true. Article 31C protects 39(b) and (c), and DPSPs help interpret Article 19, but statement R is not the cause of statement A.",
    },
    {
      text: "Which of the following is/are among Directive Principles of State Policy?\n1. State shall strive to promote science and technology.\n2. State shall endeavour to secure a Uniform Civil Code.\n3. State shall try to develop population policy.\n4. State shall take steps to promote tourism.",
      options: ["1 and 3", "2 and 4", "2 only", "1, 2, 3 and 4"],
      correctAnswer: 2,
      explanation:
        "Only the Uniform Civil Code (Article 44) is an official DPSP listed in the Constitution.",
    },
    {
      text: "The Directive Principles of State Policy are fundamental for the:",
      options: [
      ...
      correctAnswer: 3,
      explanation:
        "Article 37 explicitly states they are 'fundamental in the governance of the country'.",
    },
    {
      text: "Assertion (A): Any individual affected due to violation of any Directive Principles, cannot move the court.\nReason (R): The Directive Principles are not justiciable.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer: 0,
      explanation:
        "Because they are non-justiciable (Reason), they cannot be enforced through a court of law (Assertion).",
    },
    {
      text: "Which statement regarding the current relationship between Fundamental Rights and Directive Principles is correct?",
      options: [
        "Directive Principles cannot get priority over Fundamental Rights in any case",
        "Directive Principles always get priority over Fundamental Rights",
        "Fundamental Rights always get priority over Directives Principles",
        "In some cases Directive Principles may get priority over Fundamental Rights",
      ],
      correctAnswer: 3,
      explanation:
        "Laws implementing Article 39(b) and 39(c) are protected even if they violate Article 14 or 19.",
    },
    {
      text: "Right to work in India is a:",
      options: [
        "Fundamental right",
        "Directive principle",
        "Constitutional right",
      ...
      correctAnswer: 1,
      explanation:
        "Right to work is mentioned under Article 41 as a Directive Principle.",
    },
    {
      text: "Assertion (A): It is the legal and Constitutional duty of the State to provide legal aid to the poor.\nReason (R): No one shall be denied justice by reason of his poverty.",
      options: [
        "Both A and R are individually true and R is the correct explanation of A",
        "Both A and R are individually true but R is not the correct explanation of A",
        "A is true but R is false",
      ...
      correctAnswer: 0,
      explanation:
        "Article 39A mandates free legal aid to ensure that justice is accessible to all, regardless of economic status.",
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        "DPSPs are amendable (e.g., 42nd and 44th Amendments changed them). They are non-enforceable and fundamental to governance.",
    },
    {
      text: "The 'Instrument of Instructions' contained in the Government of India Act, 1935, has been incorporated in the Constitution as:",
      options: [
        "Fundamental Rights",
        "Directive Principles of State Policy",
        "Fundamental Duties",
      ...
      correctAnswer: 1,
      explanation:
        "The DPSPs are the modern name for the Instrument of Instructions issued to the Governor-General under the 1935 Act.",
    },
    {
      text: "Which one of the following is not a correct description of the Directive Principles of State Policy?",
      options: [
        "Not enforceable by courts",
        "Have a political sanction",
        "Declaration of objectives for State Legislation",
        "Promise equal income and free health care for all",
      ],
      correctAnswer: 3,
      explanation:
        "The Constitution does not promise *equal* income (which is impossible) or specific *free health care* for all as a direct command, but rather aims to minimize income inequalities and improve health.",
    },
    {
      text: "Consider the following statements:\n1. Article 46 provides for free legal aid to SCs and STs.\n2. Article 44 provides for promotion of cottage industries.",
      options: ["Only 1", "Only 2", "Both 1 and 2", "Neither 1 nor 2"],
      correctAnswer: 3,
      explanation:
        "Article 46 deals with the educational and economic interests of SC/STs. Article 44 is the Uniform Civil Code. Cottage industries are under Article 43.",
    },
  ],
  "Fundamental Duties": [
    {
      text: "Which of the following are Fundamental Duties of an Indian citizen according to Article 51-A?\n1. To believe in socialism, secularism and democracy\n2. To abide by the Constitution and respect the Flag and Anthem\n3. To protect the sovereignty, unity and integrity of India\n4. To preserve the rich heritage of composite culture\n5. To help the poor and weaker sections",
      options: ["1, 2 and 3", "2, 3 and 4", "3, 4 and 5", "1, 4 and 5"],
      correctAnswer: 1,
      explanation:
        "Statements 2, 3, and 4 are explicitly listed in Article 51-A. Believing in specific ideologies or general charity are not codified duties.",
    },
    {
      text: "Which statements regarding Fundamental Duties are correct?\n1. Can be enforced through writ jurisdiction.\n2. Formed part of the Constitution since adoption.\n3. Added on recommendations of Swaran Singh Committee.\n4. Applicable only to citizens.",
      options: ["1, 2 and 3", "1, 2 and 4", "2 and 3", "3 and 4"],
      correctAnswer: 3,
      explanation:
        "Fundamental Duties are non-justiciable (no writs), were added by the 42nd Amendment (not original), and apply only to citizens.",
    },
    {
      text: "Which of the following duties have been prescribed as Fundamental Duties?\n1. To defend the country\n2. To pay income tax\n3. To preserve the rich heritage of composite culture\n4. To safeguard public property",
      options: ["1 and 2", "2 and 4", "1, 2 and 4", "1, 3 and 4"],
      correctAnswer: 3,
      explanation:
        "Paying income tax is not a Fundamental Duty in the Indian Constitution.",
    },
    {
      text: "Which of the following is a fundamental duty of every citizen of India?",
      options: [
        "To be truthful to one's duties",
        "To renounce practices derogatory to the dignity of children",
        "To renounce practices derogatory to the dignity of human beings",
        "To renounce practices derogatory to the dignity of women",
      ],
      correctAnswer: 3,
      explanation:
        "Article 51-A(e) specifically mentions renouncing practices derogatory to the dignity of women.",
    },
    {
      text: "The 'Fundamental Duties' are intended to serve as a reminder to:",
      options: [
        "The State to perform duties",
        "The judiciary to administer justice",
        "Every citizen to observe basic norms of democratic conduct",
        "The legislature to make laws",
      ],
      correctAnswer: 2,
      explanation:
        "They serve as a moral compass for citizens while they exercise their rights.",
    },
    {
      text: "Which of the following are included in the list of fundamental duties?\n1. To abide by the Constitution\n2. To safeguard public property\n3. To uphold and protect sovereignty\n4. To uphold and protect secularism",
      options: ["1, 3 and 4", "1, 2 and 4", "2, 3 and 4", "1, 2 and 3"],
      correctAnswer: 3,
      explanation:
        "Upholding secularism is a constitutional value, but not a specific Fundamental Duty listed under Article 51-A.",
    },
    {
      text: "Respect for the National Flag and the National Anthem is:",
      options: [
        "A fundamental right",
        "A fundamental duty",
      ...
      correctAnswer: 1,
      explanation:
        "It is the very first Fundamental Duty listed in Article 51-A(a).",
    },
    {
      ...
      correctAnswer: 3,
      explanation:
        "Citizens are required to safeguard *public* property, not private property, as a Fundamental Duty.",
    },
    {
      text: "Fundamental duties have been added by the 42nd Amendment Act, 1976, in accordance with:",
      options: [
        "Santhannam Committee",
        "Sarkaria Committee",
        "Swaran Singh Committee",
        "Indira Gandhi-Nehru Committee",
      ],
      correctAnswer: 2,
      explanation:
        "The Swaran Singh Committee recommended the inclusion of Fundamental Duties during the Emergency.",
    },
    {
      text: "Which one of the following has not been enumerated as a fundamental duty?",
      options: [
        "Value and preserve rich heritage",
        "Safeguard public property",
        "Develop scientific temper",
        "Secure a social order for welfare of people",
      ],
      correctAnswer: 3,
      explanation:
        "Securing a social order is a Directive Principle of State Policy (Article 38), not a Fundamental Duty.",
    },
    {
      text: "Which one of the following is not a fundamental duty?",
      options: [
      ...
      correctAnswer: 2,
      explanation:
        "Protecting monuments of national importance is a Directive Principle (Article 49). Fundamental Duties mention protecting the natural environment and public property.",
    },
    {
      text: "Consider the following statements:\nFundamental duties:\n1. Have always been a part of the Constitution\n2. Have been added through an amendment\n3. Are mandatory on all citizens",
      options: ["1 and 3", "Only 1", "Only 2", "2 and 3"],
      correctAnswer: 2,
      explanation:
        "They were added by the 42nd Amendment in 1976. While they are expected of citizens, they are not legally 'mandatory' in the sense of having immediate criminal penalties for non-performance unless separate laws exist.",
    },
    {
      text: "Which one of the following is not a fundamental duty under Article 51-A?",
      options: [
        "Render national service",
        "To cast vote in the elections",
        "To strive for excellence",
        "To develop scientific temper",
      ],
      correctAnswer: 1,
      explanation:
        "Voting is a constitutional/legal right, but it is not currently listed as a Fundamental Duty.",
    },
    {
      text: "Which of these are fundamental duties of the citizens?\n1. Develop scientific temper\n2. Promote common brotherhood\n3. Organise village panchayats\n4. Minimize inequalities\n5. Secure a uniform civil code\n6. Defend the country",
      options: ["1, 3 and 4", "3, 4 and 5", "1, 2 and 6", "2, 5 and 6"],
      correctAnswer: 2,
      explanation:
        "Organizing panchayats, minimizing inequality, and UCC are Directive Principles (Part IV). The rest are Fundamental Duties.",
    },
    {
      text: "Which one of the following is not included as a Fundamental Duty?",
      options: [
        "Cherish and follow noble ideals of national struggle",
        "Develop scientific temper",
      ...
      correctAnswer: 2,
      explanation:
        "While protecting minorities is a constitutional goal, it is not listed as a specific Fundamental Duty for citizens under Article 51-A.",
    },
    {
      text: "Protection of lakes is an objective expressly stated in which one of the following?",
      options: [
        "Fundamental Duties",
        "Directive Principles of State Policy",
        "Fundamental Rights",
      ...
      correctAnswer: 0,
      explanation:
        "Article 51-A(g) specifically mentions protecting and improving the natural environment including forests, *lakes*, rivers, and wildlife.",
    },
    {
      text: "In which year were the Fundamental Duties added to the Constitution?",
      options: ["1965", "1976", "1979", "1982"],
      correctAnswer: 1,
      explanation: "They were introduced by the 42nd Amendment Act in 1976.",
    },
    {
      text: "Which Articles of the Constitution relate to the protection and improvement of environment?",
      options: [
        "Article 48A only",
        "Article 51A only",
        "Both Article 48A and Article 51A",
        "Neither Article 48A nor Article 51A",
      ],
      correctAnswer: 2,
      explanation:
        "Article 48A is a DPSP (State's duty) and 51A(g) is a Fundamental Duty (Citizen's duty) regarding the environment.",
    },
  ],
  "Amendment of the Constitution": [
    {
      text: "Consider the following statements:\n1. An amendment can be initiated only in the Lok Sabha.\n2. The Bill has to be passed by a majority of total membership and 2/3rd majority of members present and voting.",
      options: ["Only 1", "Only 2", "Both 1 and 2", "Neither 1 nor 2"],
      correctAnswer: 1,
      explanation:
        "Statement 1 is false because it can be initiated in *either* House. Statement 2 correctly defines the special majority required under Article 368.",
    },
    {
      text: "Which of the following items require ratification by half of the States for a Constitutional Amendment?\n1. Representation of States in Parliament\n2. Any of the Lists in the Seventh Schedule\n3. Manner of election of the President",
      options: ["1 and 2", "2 and 3", "1 and 3", "1, 2 and 3"],
      correctAnswer: 3,
      explanation:
        "All three touch upon the federal character of the Constitution and thus require state ratification.",
    },
    {
      text: "Restriction of the writ jurisdiction of the High Courts under Article 226 is possible through:",
      options: [
        "Special majority in Parliament",
        "Simple majority in both Houses",
        "Special majority in Parliament + ratification by half of states",
        "Special majority in Parliament + ratification by 3/4th of states",
      ],
      correctAnswer: 2,
      explanation:
        "The judiciary's powers are part of the federal structure; changing them requires the most stringent amendment process (Article 368 + State ratification).",
    },
    {
      text: "On receipt of a Constitutional Amendment Bill, after passing by each House, the President:",
      options: [
      ...
      correctAnswer: 0,
      explanation:
        "The 24th Amendment Act made it obligatory for the President to give assent to a Constitutional Amendment Bill.",
    },
    {
      text: "On which matters can Parliament modify the Constitution by a simple majority?\n1. Alteration of names/boundaries of States\n2. Appointment of additional judges\n3. Abolition of second chamber of State Legislature\n4. Administration of Scheduled Areas",
      options: ["1, 2 and 3", "1, 2 and 4", "1, 3 and 4", "2, 3 and 4"],
      correctAnswer: 2,
      explanation:
        "Appointment of additional judges is an executive/judicial process not requiring a constitutional amendment. The others are done by simple majority as per specific Articles (3, 169, etc.).",
    },
    {
      text: "The constituent power of Parliament to amend the Constitution:",
      options: [
        "Includes power to amend by way of addition, variation or repeal",
        "Is unrestricted by any inherent limitations",
        "Is not procedurally limited",
        "Is extra-constituent",
      ],
      correctAnswer: 0,
      explanation:
        "Article 368 explicitly states that Parliament may amend by way of addition, variation, or repeal any provision of the Constitution.",
    },
    {
      text: "Which change does NOT require ratification by half of the states?",
      options: [
      ...
      correctAnswer: 3,
      explanation:
        "Article 161 is not among the specific articles listed in Article 368 that require state ratification for amendment.",
    },
    {
      text: "Which features are present in the Indian Constitution?\n1. Multiple procedures for amendment\n2. States are not empowered to initiate amendment\n3. Joint-sittings for constitutional amendments",
      options: ["1 and 3", "1 and 2", "2 and 3", "1, 2 and 3"],
      correctAnswer: 1,
      explanation:
        "There is no provision for a joint sitting to resolve deadlocks on a Constitutional Amendment Bill.",
    },
    {
      text: "A Constitutional amendment shall also be ratified by states if it changes:",
      options: [
        "Fundamental Rights",
      ...
      correctAnswer: 3,
      explanation:
        "Provisions relating to the High Courts (Chapter V of Part VI) require state ratification.",
    },
    {
      text: "An amendment for the purpose of creating a new state must be passed by:",
      options: [
        "Simple majority in Parliament",
        "Simple majority + half state ratification",
        "Two-thirds majority in Parliament + 2/3rd state ratification",
        "Two-thirds of members present and voting",
      ],
      correctAnswer: 0,
      explanation:
        "Creating a new state under Article 3 and 4 is done by a simple majority and is not deemed an amendment under Article 368.",
    },
  ],
  "Basic Structure of the Constitution": [
    {
      text: "Which are considered parts of the basic structure of the Indian Constitution?\n1. Republican and democratic form of Government\n2. Secular character\n3. Division between Fundamental Rights and DPSPs\n4. Federal character",
      options: ["1, 2 and 3", "2, 3 and 4", "1, 3 and 4", "1, 2 and 4"],
      correctAnswer: 3,
      explanation:
        "The division/separation of Fundamental Rights and DPSPs is not a part of basic structure; in fact, their balance is.",
    },
    {
      text: "Statement I: Power under Article 368 does not include power to alter basic structure.\nStatement II: Right to Equality does not form part of the basic structure.",
      options: [
        "Both statements true, II is correct explanation",
        "Both statements true, II is not correct explanation",
        "Statement I true, Statement II false",
        "Statement I false, Statement II true",
      ],
      correctAnswer: 2,
      explanation:
        "Statement I is the core of the Kesavananda Bharati ruling. Statement II is false because the Right to Equality (Rule of Law) is a basic feature.",
    },
    {
      text: "The constitutional power of Parliament to amend the Constitution was laid down under Article 368 by:",
      options: [
        "1st Amendment 1951",
        "24th Amendment 1971",
        "26th Amendment 1971",
      ...
      correctAnswer: 1,
      explanation:
        "The 24th Amendment was enacted to clarify that Parliament has the power to amend any part of the Constitution, including Fundamental Rights.",
    },
    {
      text: "In which case did the Supreme Court pronounce the 'basic structure' judgement for the first time?",
      options: [
      ...
      correctAnswer: 2,
      explanation:
        "The Kesavananda Bharati v. State of Kerala (1973) case introduced this doctrine.",
    },
    {
      text: "Which one of the following statements is correct?",
      options: [
        "Constitution clearly lays down basic structure",
        "Supreme Court has elaborately defined basic structure",
        "Law Commission has defined basic structure",
        "Neither Supreme Court nor Parliament have defined basic structure",
      ],
      correctAnswer: 3,
      explanation:
        "There is no exhaustive definition. The Court determines what constitutes basic structure on a case-by-case basis.",
    },
    {
      text: 'Which Amendment inserted the provision "Nothing in Article 13 shall apply to any amendments made under Article 368"?',
      options: [
        "42nd Amendment",
        "44th Amendment",
        "24th Amendment",
      ...
      correctAnswer: 2,
      explanation:
        "The 24th Amendment (1971) added this to bypass the Golaknath case ruling.",
    },
    {
      text: "Under Article 368, Parliament has no power to repeal Fundamental Rights because these are:",
      options: [
